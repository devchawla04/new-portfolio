...
export default function SignButton() {
  ...
  const isSubmitDisabled =
    isLoading || !hasSignature || !hasMessage || !isValid || !hasName;
  ...
  const handleEmailValidation = () => {
    ...
    if (!normalizedEmail) {
      toast.error("Please add an email before verifying.");
      return;
    }
            ...
            >
              ...
              >
                ...
                <div className="px-2 mt-10 sm:px-6">
                  ...
                  <p className="text-xs mb-5 text-neutral-600 dark:text-neutral-400">
                    Missing: {!hasMessage ? "message, " : ""}
                    {!isValid ? "verified email, " : ""}
                    {!hasName ? "name, " : ""}
                    {!hasSignature ? "signature" : ""}
                    {hasMessage && isValid && hasName && hasSignature
                      ? "all set"
                      : ""}
                  </p>
                </div>
